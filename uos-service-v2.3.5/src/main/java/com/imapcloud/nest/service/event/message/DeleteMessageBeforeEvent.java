 ...
 * @Description 消息-删除前事件-校验判断、安全检查等
 * @createTime 2022年04月14日 17:55:00
 */
public class DeleteMessageBeforeEvent extends AbstractEvent<List<PubMessageEntity>> {
     ...
     */
    public DeleteMessageBeforeEvent(List<PubMessageEntity> source) {
        super(source);
    }
}
