 ...
 * @author zhongtb
 * @version 1.0.0
 * @ClassName DJIAirLineThreadPoolConfig.java
 * @Description DJIAirLineThreadPoolConfig
 * @createTime 2022年03月23日 09:12:00
 */
@Configuration
@Slf4j
public class DJIAirLineThreadPoolConfig {
    ...
    private final String threadNamePrefix = "djiAirLineExecutor";
     ...
     * @return
     */
    @Bean("djiAirLineExecutor")
    public ThreadPoolTaskExecutor djiExecutor() {
