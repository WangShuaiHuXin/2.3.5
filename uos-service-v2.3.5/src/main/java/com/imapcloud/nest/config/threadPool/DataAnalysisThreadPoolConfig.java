 ...
 * @author zhongtb
 * @version 1.0.0
 * @ClassName DataAnalysisThreadPoolConfig.java
 * @Description DataAnalysisThreadPoolConfig
 * @createTime 2022年03月23日 09:12:00
 */
@Configuration
@Slf4j
public class DataAnalysisThreadPoolConfig {
    ...
    private final String threadNamePrefix = "dataAnalysisExecutor";
