package com.imapcloud.nest.utils.utm2gps;
...
public class CoordinateConversion {
    ...
    public int getZone(Double longitude) {
    ...
    private class UTM2LatLon {
        ...
        public double[] convertUTMToLatLong(String UTM) {
            ...
            zone = (int) (Double.parseDouble(utm[0]) / 6) + 31;
            LatZones latZones = new LatZones();
            String latZone = latZones.getLatZone(Double.parseDouble(utm[1]));
