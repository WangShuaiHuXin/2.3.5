...
@ApiModel("磁罗盘校准参数")
@Data
public class UavCalibrationCompassVO implements Serializable {
    ...
    @ApiModelProperty(value = "0-关闭校准，1-开启校准", position = 3, example = "1", required = true)
    @LimitVal(values = {"0","1"}, message = "enable值不在范围")
