 ...
 */
@ToString
public final class PowerDefectOutDTO {

    private PowerDefectOutDTO() {}
    ...
    @Data
    public static class DetailOutDTO implements Serializable {
        ...
        private List<DefectMarkInfo> defectMarkInfoList;
    }

    @Data
    public static class DefectMarkInfo {
