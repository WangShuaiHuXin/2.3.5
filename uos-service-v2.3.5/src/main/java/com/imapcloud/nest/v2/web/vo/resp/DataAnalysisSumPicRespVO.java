...
public class DataAnalysisSumPicRespVO implements Serializable {
    ...
    @ApiModelProperty(value = "日期", position = 9, example = "")
    private String sortDate;
    @ApiModelProperty(value = "已分析数量", position = 10, example = "")
    private Integer hadAnalyzeSum;
    @ApiModelProperty(value = "已发现问题数量", position = 11, example = "")
