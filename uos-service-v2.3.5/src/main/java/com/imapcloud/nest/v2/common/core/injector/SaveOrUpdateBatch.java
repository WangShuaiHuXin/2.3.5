...
public class SaveOrUpdateBatch extends AbstractMethod {
    ...
    private List<String> fields = CollectionUtil.newArrayList("ID");
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, "saveOrUpdateBath", sqlSource, new NoKeyGenerator(), null, null);
    }
