 ...
 * @since 2.1.5
 */
public class SystemAITaskProcessSnapshot implements ISystemAITaskProcess {
    ...
    public SystemAITaskProcessSnapshot(SystemAIAnalysisTask task) {
    ...
    public SystemAITaskProcessSnapshot(AITaskProcessBuilder builder) {
        ...
        this.orgCode = builder.getOrgCode();
    }
