 ...
 */
public class SynDataValidateException extends BizException {
    private static final long serialVersionUID = 1L;
    private String msg;

    public SynDataValidateException(String msg) {
        super(msg);
        this.msg = msg;
    }

    public SynDataValidateException(String msg, Throwable e) {
        super(msg, e);
        this.setMsg(msg);
    }
