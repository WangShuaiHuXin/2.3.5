...
@ApiModel("大疆登陆")
@Data
public class UavDjiLoginControlVO implements Serializable {
    ...
    @ApiModelProperty(value = "用户名", position = 1, example = "1",required = true)
    @NotNull(message = "用户名不能为空")
    private String userName;

    //cps用的也是明文，后续要考虑安全
    @ApiModelProperty(value = "密码", position = 1, example = "1",required = true)
